...
const MainAbout = () => {
  return (
    <section id="about container" className="about">
      <div className="oval">
            ...
            <div className="col-md-8 left">
              <div className="main-text">
                ...
                <span>
                  ...
                  lives and shape the future. When I am not coding or building
                  businesses, you can find me in the fields, exploring my
                  passion for agriculture and sustainable living. I believe in
                  the importance of feeding our communities and promoting
                  eco-friendly practices. As a car enthusiast, I also enjoy the
                  thrill of the open road and the beauty of well-designed
                  machines.
                </span>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-md-8 left">
              <div className="main-text">
                <h2>Journey</h2>
                <span>
                  I set out on a challenge to build a series companies,
                  each one a stepping stone to greater success. From my first
